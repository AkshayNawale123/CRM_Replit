  ...
  private seedData() {
    ...
    const sampleClients: Omit<Client, "id">[] = [
      ...
      },
      {
        ...
        responsiblePersonId: null,
        service: "ERP",
        serviceId: serviceArray.find(s => s.name === "ERP")?.id || null,
        country: "Canada",
        linkedin: "",
      ...
      },
      {
        ...
        serviceId: serviceArray.find(s => s.name === "Product Development")?.id || null,
      ...
      },
      {
        ...
        serviceId: serviceArray.find(s => s.name === "Website Creation")?.id || null,
        country: "Australia",
        linkedin: "",
      ...
      },
      {
        ...
        serviceId: serviceArray.find(s => s.name === "Mobile Development")?.id || null,
        country: "Singapore",
      ...
      },
      {
        ...
        responsiblePersonId: null,
        service: "ITSM",
        serviceId: serviceArray.find(s => s.name === "ITSM")?.id || null,
        country: "United States",
        linkedin: "",
      ...
      },
      {
        ...
        serviceId: serviceArray.find(s => s.name === "Digital Marketing")?.id || null,
        country: "Canada",
